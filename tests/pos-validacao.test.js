// Testes das funções puras de src/pos-validacao.js — a cópia CONGELADA da
// metodologia de ciclos da PNP que serve a página Pós-Graduação Validação.
//
// Enquanto o painel principal é remodelado, esta suíte é a que garante que as
// regras congeladas continuam valendo. tests/posgraduacao.test.js segue o
// arquivo do painel principal, que vai mudar.
'use strict';

const path = require('path');
const { createBrowserContext, loadScript } = require('./helpers/browserEnv');

const POSGRAD_PATH = path.join(__dirname, '..', 'src', 'pos-validacao.js');
