...
- [x] Add 7th tab button "Pós-Graduação" to navigation
...
- [x] Add post-graduation filters to filter panel:
  - [x] `posgrad-categoria-filter` (Mestrado/Doutorado/Especialização)
  - [x] `posgrad-status-filter` (Matriculado/Concluído/Cancelado/etc.)
...
- [x] **`renderChartsPosGraduacao()`** — main dispatch, defaults to Visão Geral
...
- [x] Responsive layout with 6–8 KPI cards per subtab
...
- **Cohort maturity threshold**: Mestrado ≥ 2 years, Doutorado ≥ 4 years, Especialização ≥ 2 years
- **Completion rate** = Concluídos (mature cohorts) / Total mature cohorts × 100
- **Attrition rate** = Cancelado/Desligado/Evasão/Abandono/Falecido / Total mature cohorts × 100
