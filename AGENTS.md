...
- `python server.py` – Start Python HTTP server on port 8000 (legacy)
...
- Static dashboard: `index.html`, `script.js`, `style.css`
...
- `server.py` is legacy; use `npm start` for development
