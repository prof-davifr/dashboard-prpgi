// pos-validacao.js — CONGELADO em 02/09/2026.
//
// Metodologia de ciclos da Plataforma Nilo Peçanha: ciclo encerrado, CCiclo,
// EvCiclo, RCiclo e Índice de Eficiência Acadêmica. Cópia fiel do que era a aba
// Pós-Graduação do painel principal até esta data.
//
// Serve apenas a página "Pós-Graduação Validação"
// (pos-validacao-f85b5515.html). NÃO EDITAR: o painel principal segue por
// src/posgraduacao.js, que tem caminho próprio a partir daqui.
//
// Dependências externas: STATE e $ (src/core.js), createChart e getChartColors
// (src/charts.js). Não usa mapa, exportação nem processData.
